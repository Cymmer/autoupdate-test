  ...
  <TopicContainer
    ...
    titleJsx={
      <Text type={textTypes.BODY.MD}>
        ...
        of the current chapter, which writes:
        <br />
        <br /> "Just like ordinary mathematics' PEMDAS rule, C++ also follows a
        similar order of priority when calculating. This concept is a vital part
        of mastering number manipulation since it would greatly affect the
        results of calculations if this was not properly understood. Therefore,
        we must understand which operation need to be solved first, and in
        programming, we call this the <strong>order of precedence</strong>."
      </Text>
    }
  >
      ...
      <SampleProblemList>
        <SampleProblemCard number={1} title="Guess the Answer">
          <Text>
            ...
            <br />
            <br /> The rule is to pick any integer from 1-9 and perform the
            following:
            <br />
            <br /> a) Multiply it by 2
            <br />
            <br /> b) Add six to the result
            <br />
            <br /> c) Divide the result by 2
            <br />
            <br /> d) Subtract the result by the original number you have
            chosen.
            <br />
            <br /> And magically, it will always result to the number 3!
            <br />
            <br /> However, it is important to follow the method step by step,
            especially since the third step involves division, which is of
            higher precedence than the second step, addition. In here comes the
            great use of parentheses, like this one below:
          </Text>
          <Compiler
            initialSourceCodes={[
              {
