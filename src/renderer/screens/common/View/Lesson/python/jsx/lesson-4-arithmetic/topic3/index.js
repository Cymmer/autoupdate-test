...
const Topic3 = () => (
  <TopicContainer
    childrenJsx={
      <Text type={textTypes.BODY.MD}>
        ...
        <br />
        <br /> "Just like ordinary mathematics’ PEMDAS rule, Python also follows
        a similar order of priority when calculating. This concept is a vital
        part of mastering number manipulation since it would greatly affect the
  ...
  >
    <Section title="The Order">
      <Text>
        Just like ordinary math, Python also follows a similar order of
        precedence when performing the operations. To illustrate, we visualize
        the order as a staircase that needs to be taken step by step before
        being able to go to the bottom part, like this:
      </Text>
      ...
      <SampleProblemList>
        <SampleProblemCard number={1} title="Guess the Answer">
          ...
          >
            ...
            following: <br />
            a) Multiply it by 2 <br />
            b) Add six to the result <br />
